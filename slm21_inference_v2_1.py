...
def parse_args():
    ...
    parser.add_argument("--test_synthetic_embed_paths", type=str, required=True, help="Path to the train file.")
    parser.add_argument("--test_librispeech_embed_paths", type=str, required=True, help="Path to the test file.")
    parser.add_argument("--dev_synthetic_embed_paths", type=str, required=True, help="Path to the train file.")
    parser.add_argument("--dev_librispeech_embed_paths", type=str, required=True, help="Path to the test file.")
...
def main():
    ...
    test_synthetic_embed_paths = args.test_synthetic_embed_paths.split(';')
    test_librispeech_embed_paths = args.test_librispeech_embed_paths.split(';')
    dev_synthetic_embed_paths = args.dev_synthetic_embed_paths.split(';')
    dev_librispeech_embed_paths = args.dev_librispeech_embed_paths.split(';')
    ...
    # Setup dataloaders 
    test_synthetic_data_loader = get_inference_loader(args.test_synthetic_path, test_synthetic_embed_paths, None, batch_size=1, shuffle=False, num_workers=0, max_seq_len=args.max_seq_length)
    test_librispeech_data_loader = get_inference_loader(args.test_librispeech_path, test_librispeech_embed_paths, None, batch_size=1, shuffle=False, num_workers=0, max_seq_len=args.max_seq_length)
    dev_synthetic_data_loader = get_inference_loader(args.dev_synthetic_path, dev_synthetic_embed_paths, None, batch_size=1, shuffle=False, num_workers=0, max_seq_len=args.max_seq_length)
    dev_librispeech_data_loader = get_inference_loader(args.dev_librispeech_path, dev_librispeech_embed_paths, None, batch_size=1, shuffle=False, num_workers=0, max_seq_len=args.max_seq_length)
