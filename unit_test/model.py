...
class TestSpeechTransformerModel(unittest.TestCase):
    ...
    def test_forward_pass(self):
        ...
        # Forward pass
        output = self.model(src, tgt, src_mask, tgt_mask, src_key_padding_mask, tgt_key_padding_mask, memory_key_padding_mask)
    ...
    def test_training_step(self):
        ...
        initial_loss = self.model.train_step(src, tgt, src_mask, tgt_mask, src_key_padding_mask, tgt_key_padding_mask, memory_key_padding_mask)
        for i in range(10):  # Train for a few steps
            loss, (acc, _, _) = self.model.train_step(src, tgt, src_mask, tgt_mask, src_key_padding_mask, tgt_key_padding_mask, memory_key_padding_mask)
