...
def main():
    ...
    # Setup dataloaders 
    train_data_loader = get_train_loader(args.train_token_file_path, args.train_embed_file_path, args.word_seg_file_path, args.batch_size, shuffle=True, num_workers=4, max_seq_len=args.max_seq_length)
    dev_data_loader = get_eval_loader(args.dev_token_file_path, args.dev_embed_file_path, args.word_seg_file_path, args.batch_size, shuffle=False, num_workers=4, max_seq_len=args.max_seq_length)
