...
if [ $stage -eq 0 ]; then 
    ...
    CUDA_LAUNCH_BLOCKING=1 python main.py \
               ...
               --vocab_size 1025 --d_model 512 --nhead 8 --num_encoder_layers 3 --num_decoder_layers 3 --dim_feedforward 2048 \
               --dropout 0.1 --max_seq_length 256 --epochs 10 --log_interval 20 --learning_rate 1e-4 --optimizer_type "adam"
fi 
...
if [ $stage -eq 1 ]; then 
    ...
    CUDA_LAUNCH_BLOCKING=1 python inference.py \
               ...
               --batch_size 32 \
               --segment_context_size 5 \
               --vocab_size 1025 --d_model 512 --nhead 8 --num_encoder_layers 3 --num_decoder_layers 3 --dim_feedforward 1024 \
